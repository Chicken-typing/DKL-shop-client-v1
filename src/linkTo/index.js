...
// Statistic
export const API_ADMIN_REVENUE = `${BASE_URL}/orders/summary`;
export const API_ADMIN_ACCESS = `${BASE_URL}/orders/summary`;
export const API_ADMIN_NEEDED = `${BASE_URL}/products`;
